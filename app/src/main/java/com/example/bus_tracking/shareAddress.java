...
public class shareAddress extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static final String TAG  = "shareaddress", LOCATION_MARKER = "my-marker";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        busNameShow.setText("Students Bus");
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS,
                new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        // STUDENTS BUS MARKER
                        //bus no 1
                        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Bus").child("Students bus").child("Bus no 1");
                        ...
                        //bus no 2
                        DatabaseReference databaseReference2 = FirebaseDatabase.getInstance().getReference("Bus").child("Students bus").child("Bus no 2");
                        ...
                        //bus 3
                        DatabaseReference databaseReference3 = FirebaseDatabase.getInstance().getReference("Bus").child("Students bus").child("Bus no 3");
